...
int Maximum_value(int node,int b,int e,int l,int r){
    ...
    return max(Maximum_value(node << 1 , b, mid, l, r) , Maximum_value(node << 1 | 1, mid+1, e, l ,r));
}
...
int main(){
    ...
    while(q--) {
        int l,r;
        cin>>l >> r; ///range
        cout<<Maximum_value(1,1,n,l,r)<<endl;
    }
    return 0;
}
